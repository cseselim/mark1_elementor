			...
			<div class="container">
				...
				<div class="col span_6">
					...
					<?php if(!empty($options['disable-auto-copyright']) && $options['disable-auto-copyright'] == 1) { ?>
						<p class="text-right"><?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> </p>
					<?php } else { ?>
						<p >&copy; <?php echo date('Y') . ' ' ." <span class='fs-copy-font'> " .get_bloginfo('name'); ?><?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> </span></p>
					<?php } ?>
